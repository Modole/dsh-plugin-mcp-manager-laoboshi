...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    `;
    if (typeof document !== "undefined" && !document.querySelector('style[data-plugin-css="@laobos/dsh-mcp-manager"]')) {
      const style = document.createElement("style");
      style.dataset.pluginCss = "@laobos/dsh-mcp-manager";
      style.textContent = css;
      document.head.appendChild(style);
    }

    const API = "/laobos/api/mcp-manager";
